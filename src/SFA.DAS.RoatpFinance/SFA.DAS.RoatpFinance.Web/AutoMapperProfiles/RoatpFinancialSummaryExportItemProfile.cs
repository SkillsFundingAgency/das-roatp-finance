...
{
    public class RoatpFinancialSummaryExportItemProfile : Profile
    {
        public RoatpFinancialSummaryExportItemProfile()
        {
            CreateMap<RoatpFinancialSummaryDownloadItem, RoatpFinancialSummaryExportItem>()
